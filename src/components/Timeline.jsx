...
function TimeLine() {
  return (
    ...
    >
      ...
      <p>
        The Mechabust project started. It was a downtime for me professionally—a perfect time to
        reflect on how to change the world. I&apos;d like to call myself an artist: besides my
        passion for games and animation, I just love to create things. I love mechs, I love 3D
        printing—so this whole thing was a no-brainer.{' '}
      </p>
