  ...
  return (
    ...
    >
      ...
      <p>
        ...
        perfect time to reflect on how to change the world. I&apos;d like to
        call myself an artist: besides my passion for games and animation, I
        just love to create things. I love mechs, I love 3D printing—so this
        whole thing was a no-brainer.{" "}
      </p>
      ...
      <Timeline position="right" sx={{ pl: 0, ml: 0 }}>
        ...
        <TimelineItem>
          ...
          {/* 2022 */}
          <TimelineContent sx={{ py: "0px", px: 2 }}>
            <Typography sx={{ width: { xs: "30rem" } }}>Pioneer-1</Typography>
          </TimelineContent>
        </TimelineItem>
        ...
        <TimelineItem>
          ...
          {/* 2022 */}
          <TimelineContent sx={{ py: "0px", px: 2 }}>
            <Typography sx={{ width: { xs: "30rem" } }}>Pioneer-2</Typography>
          </TimelineContent>
        </TimelineItem>
        ...
        <TimelineItem>
          ...
          <TimelineContent sx={{ py: "12px", px: 2 }}>
            ...
            <Typography sx={{ width: { xs: "30rem" } }}>
              The Mech Head, Pioneer-3 MVP is Live! The base kit is fully
              designed and ready for you to download. This is our starting
              point.
            </Typography>
          </TimelineContent>
        </TimelineItem>
        ...
        <TimelineItem>
          ...
          <TimelineContent sx={{ py: "12px", px: 2 }}>
            ...
            <Typography sx={{ width: { xs: "30rem" } }}>
              Community building… stay tuned guys!
            </Typography>
          </TimelineContent>
        </TimelineItem>
      </Timeline>
